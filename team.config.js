...
module.exports = {
  ...
  team: {
    Philip: { name: 'Philip Hall',    role: 'Manager', password: 'rithum2025' },
    Owen:    { name: 'Owen Jones',      role: 'Strategic Account Director',     password: 'rithum2025' },
    Julia:    { name: 'Julia Stolyarova',      role: 'Strategic Account Director',     password: 'rithum2025' },
    Gary:    { name: 'Gary Seneviratne',      role: 'Strategic Account Director',     password: 'rithum2025' },
    Seb:    { name: 'Seb Bauer',      role: 'Strategic Account Director',     password: 'rithum2025' },
    Rich:    { name: 'Rich Barber',      role: 'Strategic Account Director',     password: 'rithum2025' },
  },
   Mussie:    { name: 'Mussie Goyrom',      role: 'Strategic Account Director',     password: 'rithum2025' },
  },
